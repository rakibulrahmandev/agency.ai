            ...
            <div className="bg-slate-50 dark:bg-gray-900/70 pt-20 sm:pt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
                ...
                <div className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <img src={assets?.facebook_icon} alt="footer social icon" />
                        <img src={assets?.twitter_icon} alt="footer social icon" />
                        <img src={assets?.instagram_icon} alt="footer social icon" />
                        <img src={assets?.linkedin_icon} alt="footer social icon" />
                    </div>
                </div>
            </div>
        </>
